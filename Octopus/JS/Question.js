...
function ranbox(listc,boxc,arrowc,num){
    ...
    if(bool){
        ...
        if(num == 15){islist15 = false;list.classList.remove('list_foces');box.classList.add('close_box');box.classList.remove('open_box');}
    }else{
        ...
        if(num == 15){islist15 = true;list.classList.add('list_foces');box.classList.add('open_box');box.classList.remove('close_box');}
    }
}
