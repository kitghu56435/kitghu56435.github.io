...
function ranbox(listc,boxc,arrowc,num){
    ...
    if(bool){
        ...
        if(num == 2){islist2 = false;list.classList.remove('list_foces');box.classList.add('close_box3');box.classList.remove('open_box3');}
        ...
        if(num == 7){islist7 = false;list.classList.remove('list_foces');box.classList.add('close_box3');box.classList.remove('open_box3');}
        ...
        if(num == 10){islist10 = false;list.classList.remove('list_foces');box.classList.add('close_box4');box.classList.remove('open_box4');}
        if(num == 11){islist11 = false;list.classList.remove('list_foces');box.classList.add('close_box');box.classList.remove('open_box');}
        ...
        if(num == 14){islist14 = false;list.classList.remove('list_foces');box.classList.add('close_box2');box.classList.remove('open_box2');}
        if(num == 15){islist15 = false;list.classList.remove('list_foces');box.classList.add('close_box3');box.classList.remove('open_box3');}
        if(num == 16){islist16 = false;list.classList.remove('list_foces');box.classList.add('close_box');box.classList.remove('open_box');}
    }else{
        ...
        if(num == 2){islist2 = true;list.classList.add('list_foces');box.classList.add('open_box3');box.classList.remove('close_box3');}
        ...
        if(num == 7){islist7 = true;list.classList.add('list_foces');box.classList.add('open_box3');box.classList.remove('close_box3');}
        ...
        if(num == 10){islist10 = true;list.classList.add('list_foces');box.classList.add('open_box4');box.classList.remove('close_box4');}
        if(num == 11){islist11 = true;list.classList.add('list_foces');box.classList.add('open_box');box.classList.remove('close_box');}
        ...
        if(num == 14){islist14 = true;list.classList.add('list_foces');box.classList.add('open_box2');box.classList.remove('close_box2');}
        if(num == 15){islist15 = true;list.classList.add('list_foces');box.classList.add('open_box3');box.classList.remove('close_box3');}
        if(num == 16){islist16 = true;list.classList.add('list_foces');box.classList.add('open_box');box.classList.remove('close_box');}
    }
}
...
mes_data[10][0] = "";
mes_data[10][1] = "Image/Q2_img4.png";
mes_data[10][2] = "";
mes_data[10][3] = "";
